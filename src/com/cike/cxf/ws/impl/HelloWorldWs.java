 ...
 * 2016-09-28T16:52:28.130+08:00
 * Generated source version: 2.7.18
 * 
 */
@WebServiceClient(name = "HelloWorldWs", 
                  wsdlLocation = "http://10.19.155.102/hello?wsdl",
...
public class HelloWorldWs extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.19.155.102/hello?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldWs.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://10.19.155.102/hello?wsdl");
        }
        WSDL_LOCATION = url;
    }
