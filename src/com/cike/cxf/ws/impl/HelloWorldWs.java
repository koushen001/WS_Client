 ...
 * 2016-10-06T12:42:36.241+08:00
 * Generated source version: 2.7.18
 * 
 */
@WebServiceClient(name = "HelloWorldWs", 
                  wsdlLocation = "http://192.168.1.103/hello?wsdl",
                  targetNamespace = "http://impl.ws.cxf.cike.com/") 
public class HelloWorldWs extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.ws.cxf.cike.com/", "HelloWorldWs");
    public final static QName HelloWorldWsPort = new QName("http://impl.ws.cxf.cike.com/", "HelloWorldWsPort");
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.1.103/hello?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldWs.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.1.103/hello?wsdl");
        }
        WSDL_LOCATION = url;
    }
